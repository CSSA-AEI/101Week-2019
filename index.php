            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <a data-fr class="page-scroll" href="#who">Qui sommes-nous?</a>
                    </li>
                    <li>
                        <a data-en class="page-scroll" href="#ticket">Buy the Kit</a>
                        <a data-fr class="page-scroll" href="#ticket">Acheter la trousse</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <p data-fr>Cette année, la semaine 101 aura lieu le <u>31 août à le 6 septembre</u></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7 col-xs-12">
                        ...
                        <p data-en>Kits will go on sale through this website on August 1st. Buying a kit reserves you a spot in the Computer Science 101 Week. There are a limited number of spots, so make sure you buy your kit! Once purchased, you will be able to pick up your kit on campus (Outside of, STEM building, 10:30 am to 3:30 pm September 2nd and 3rd, 9:30 am to 2:00 pm September 4th).</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <script>
                    ...
                    var countDownDate = new Date("Sept 2, 2019 09:30:00").getTime();
    ...
    <section id="ticket" class="ticket">
        <div class="ticket-content">
            <div class="container">
                ...
                <a data-en href="/checkout.php" class="btn btn-outline btn-xl page-scroll">I'm joining 101 Week!</a>
                <a data-fr href="/checkout.php" class="btn btn-outline btn-xl page-scroll">Je me joint à 101 semaines!</a>
            </div>
        </div>
        <div class="overlay"></div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="list-inline list-social">
                <li class="social-twitter">
                    <a href="https://twitter.com/CSSAAEI"><i class="fa fa-twitter"></i></a>
                </li>
                <li class="social-facebook">
                    <a href="https://www.facebook.com/CSSAAEI"><i class="fa fa-facebook"></i></a>
                </li>
                <li class="social-instagram">
                    <a href="https://www.instagram.com/cssa.aei/"><i class="fa fa-instagram"></i></a>
                </li>
            </ul>
        </div>
    </section>
