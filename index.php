    ...
    <section id="ticket" class="ticket">
        <div class="ticket-content">
            <div class="container">
                ...
                <a data-en href="/checkout.html" class="btn btn-outline btn-xl page-scroll">I'm joining 101 Week!</a>
                <a data-fr href="/checkout.html" class="btn btn-outline btn-xl page-scroll">Je me joint à 101 semaines!</a>
            </div>
        </div>
        <div class="overlay"></div>
    </section>
